...
| Phase 0 #4 深空扩 6 凑 12 | 12/110 闭项 | 0908 扩 6 commit |
| Phase 1 W2 后端骨架 | 5 端点 FastAPI | `70596d3` |
| 主 JSON total | 73(branch 31 / planet 9 / constellation 9 / **deep_sky_object 12** / master 4 / quote 4 / story 2 / legend 2) | — |
...
python3 scripts/merge_deep_sky_seed.py         # 0906 步 5 合并器 + 0908 扩 6 凑 12
```
三脚本幂等(同 id 二次合并 = skipped,不重复追加);`merge_deep_sky_seed.py` 0908 二次跑 12 个 dso-m* 全 skipped,73 条不变。

### 下一步(已 commit,留待 0909+ 批次)
- 88 星座 9/88 → 18 凑 27(NW/N4/N1 三批,每批 6 条需查 IAU 88 完整表)
- Phase 0 #3(200 亮星 HYG 数据库)/ #4(110 梅西耶 M3-M110 98 条续)/ 事件库(0/20)三资产未启动
